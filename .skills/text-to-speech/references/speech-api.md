...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cinpfjatarr5-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech` |
| HTTP Method | `POST` |
...
async function textToSpeech(
  ...
  const response = await fetch("https://app-cinpfjatarr5-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech", {
    method: "POST",
    headers: {
...
```bash
curl -s -X POST "https://app-cinpfjatarr5-api-GYX1lzGw01Xa.gateway.appmedo.com/v1/audio/speech" \
