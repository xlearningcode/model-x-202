...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-cinpfjatarr5-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-cinpfjatarr5-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
...
async function listExpandTasks(pageNum = 1, pageSize = 30): Promise<Array<{
  ...
  const url = new URL(
    "https://app-cinpfjatarr5-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand"
  );
